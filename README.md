...
Далее мы создаём новую ветку для конкретной задачи и работает в ней. Работаем-работаем, добавляем, сохраняем, тестируем, исправляем, снова сохраняем — и, главное, комитим.

Далее отправляем свою версию в свой GitHub, а уже на GitHub'е жмём кнопку Pull Request.
